...
from selenium.common.exceptions import InvalidArgumentException as InvalidArgumentException, NoSuchCookieException as NoSuchCookieException, UnknownMethodException as UnknownMethodException, WebDriverException as WebDriverException
...
class WebDriver:
    ...
    capabilities: Any
    error_handler: Any
    def __init__(self, command_executor: str = ..., desired_capabilities: Any | None = ..., browser_profile: Any | None = ..., proxy: Any | None = ..., keep_alive: bool = ..., file_detector: Any | None = ..., options: Any | None = ...) -> None: ...
    def __enter__(self): ...
    def __exit__(self, *args) -> None: ...
    def file_detector_context(self, file_detector_class, *args, **kwargs) -> None: ...
    @property
    def mobile(self): ...
    @property
    def name(self): ...
